...
class FullScreenCircularProgressDialog : Dialog {
    ...
    constructor(context: Context) : super(context, R.style.FullScreenCircularProgressDialog) {
        ...
        mRotationImage = view.findViewById<ImageView>(R.id.full_screen_circular_progress_dialog_iv);
        mMessage = view.findViewById<TextView>(R.id.full_screen_circular_progress_dialog_message_tv);
